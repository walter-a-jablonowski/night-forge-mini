...
> Smallest **working** version of [idea.md](<260621 - idea.md>): **one hardcoded domain**, the
...
> See `tasks/v done/260621 - domain-pack-template.md`.
...
- Domain Pack + registry packaging (drop-in specializations) → `tasks/v done/260621 - domain-pack-template.md`
