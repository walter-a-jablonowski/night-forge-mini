...
0. long-run findings (2026-09-11) — 7 bugs from 6 live passes on an unfamiliar topic;
   6 fixed, 1 deliberately downgraded. The record of what was wrong and why, kept
